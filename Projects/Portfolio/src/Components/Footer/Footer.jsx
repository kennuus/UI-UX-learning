...
function Footer() {
	return (
		<footer
			className='
    absolute bottom-0 left-0 right-0 justify-center flex
    bg-black dark:bg-white 
    md:w-[300px] h-36 md:h-32 md:rounded-t-xl  md:mx-auto '
		>
			<div className='justify-center flex gap-3 absolute top-6'>
				<a
					aria-label='GitHub link'
					target='_blank'
					className='md:hover:scale-125 md:w-[36px] md:h-[36px] w-[48px] h-[48px]'
				...
				>
					<svg
						...
						strokeWidth={1.5}
						stroke='currentColor'
						className='md:w-[36px] md:h-[36px] w-[48px] h-[48px]'
					>
						{' '}
				...
				<div className='md:h-[36px] h-[48px] w-[1px] bg-white dark:bg-black' />
			...
			<a
				className='bg-white dark:bg-black rounded-sm h-min absolute bottom-8 md:text-[16px]'
